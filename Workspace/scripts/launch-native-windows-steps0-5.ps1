...
$env:DENTOBOT_WORKFLOW_PROFILE = "native-windows-steps-0-5"

Write-Host "DENTOBOT native Windows Steps 0-5 fallback check passed."
...
Write-Host "Workflow: Steps 0-5 only; Step 6 and SlicerROS2 are disabled"
Write-Host "ROS profile: none"
