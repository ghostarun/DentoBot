...
class LogicConstantsMixin:
    ...
    SEMANTIC_SCHEMA_ATTRIBUTE = "DENTOBOT.SemanticSchemaVersion"

    SEMANTIC_STATUS_ATTRIBUTE = "DENTOBOT.SemanticStatus"

    SEMANTIC_FINGERPRINT_ATTRIBUTE = "DENTOBOT.SemanticFingerprint"

    SEMANTIC_PERSISTENCE_ATTRIBUTE = "DENTOBOT.SemanticPersistenceState"
