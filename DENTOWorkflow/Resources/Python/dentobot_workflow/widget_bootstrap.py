...
class BootstrapWidgetMixin:
    def __init__(self, parent=None) -> None:
        ...
        self._step3SubstepNavigator = None
        self._step3SubstepComboBox = None
        self._step3PreviousSubstepButton = None
        self._step3NextSubstepButton = None
        self._step3SubstepIndex = 0
        self._updatingStep3SubstepNavigation = False
        self._step3AContentWidget = None
        self._step3BPlacementHost = None
        self._step3BContinueButton = None
        self._step61PlacementMirrorStatusLabel = None
